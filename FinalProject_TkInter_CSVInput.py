...
url = "https://raw.githubusercontent.com/andrewcrawford-utexas/ME396-Group-2/main/Gait10dof18musc/muscle_static_op.csv" # Make sure the url is the raw version of the file on GitHub
...
hamstrings_r = df["hamstrings_r"].values.tolist()
bifesh_r = df["bifemsh_r"].values.tolist()
glut_max_r = df["glut_max_r"].values.tolist()
iliopsoas_r = df["iliopsoas_r"].values.tolist()
rect_fem_r = df["rect_fem_r"].values.tolist()
vasti_r = df["vasti_r"].values.tolist()
gastroc_r = df["gastroc_r"].values.tolist()
soleus_r = df["soleus_r"].values.tolist()
tib_ant_r = df["tib_ant_r"].values.tolist()

hamstrings_l = df["hamstrings_l"].values.tolist()
bifesh_l = df["bifemsh_l"].values.tolist()
glut_max_l = df["glut_max_l"].values.tolist()
iliopsoas_l = df["iliopsoas_l"].values.tolist()
rect_fem_l = df["rect_fem_l"].values.tolist()
vasti_l = df["vasti_l"].values.tolist()
gastroc_l = df["gastroc_l"].values.tolist()
soleus_l = df["soleus_l"].values.tolist()
tib_ant_l = df["tib_ant_l"].values.tolist()
