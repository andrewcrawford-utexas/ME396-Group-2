...
def hamstrings1():
    hamstrings = tk.Button(root, text="Hamstrings", command = lambda:hamstrings2(), font = my_font, borderwidth=2, relief="solid", fg='white',bg='#345', cursor='hand2', padx=5, pady=5).place(x=522, y=384)
